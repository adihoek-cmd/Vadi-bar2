...
const DEFAULT_INVENTORY = [
  ...
  { id:"i179", cat:"Spirit", kind:"Rum", label:"Angostura 1919", priceNIS:179.9, sizeMl:700, on:false, info:{ abv:"40%", origin:"Trinidad & Tobago", description:"Angostura 1919 is a blended Trinidadian rum aged up to 8 years in charred ex-bourbon casks — soft and rounded with vanilla, caramel, cocoa and baking spice. A gentle, dessert-leaning sipper that also shines in an aged-rum Old Fashioned or Rum Sour. Not yet in stock — arriving." } },
  ...
  { id:"i61", cat:"Spirit", kind:"Cognac", label:"Torres 10", priceNIS:99.9, sizeMl:700, on:true, info:{ abv:"38%", origin:"Penedès, Spain", description:"Torres 10 is Spain's best-known brandy — a 10-year solera-aged blend in American oak (since 1928), rich and rounded with vanilla, cinnamon and oak spice." } },
  ...
  { id:"i178", cat:"Modifier", kind:"Blanc Vermouth", label:"Dolin Blanc", priceNIS:39.9, sizeMl:750, on:false, info:{ abv:"16%", origin:"Chambéry, France", description:"Dolin Blanc is a clear, gently sweet blanc vermouth from Chambéry — floral and honeyed with alpine herbs and a soft bitter finish. Sits between dry and rouge; brilliant in a 50/50 Martini, El Presidente or simply over ice with a lemon twist. Not yet in stock — arriving." } },
  // Campari
  ...
  // Bitter Bianco
  { id:"i153", cat:"Modifier", kind:"Bitter Bianco", label:"Luxardo Bitter Bianco", priceNIS:89.9, sizeMl:700, on:true, info:{ abv:"30%", origin:"Italy", description:"Luxardo Bitter Bianco is a clear bitter aperitivo — delicate, herbaceous and citrusy with rosemary and white pepper. A refined, colorless alternative to Campari for a White Negroni." } },
  // Amaro
